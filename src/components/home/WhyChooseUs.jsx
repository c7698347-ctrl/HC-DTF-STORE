...
import { Truck, Award, Layers, ShieldCheck } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-slate-900/90 p-6 rounded-3xl border border-slate-800 space-y-3 hover:border-emerald-500/40 transition group">
            ...
            <h3 className="font-extrabold text-base text-white">Fast Dispatch Across India</h3>
            <p className="text-xs text-slate-400 leading-relaxed font-medium">Ships within 1–3 Business Days</p>
          </div>
